...
mcp = FastMCP(
    name="All in one",
    stateless_http=True  # Fixed: removed extra space
)

@mcp.prompt(name="lesson_plan")  # Fixed: use underscore instead of space
...
async def calculate(expression: str) -> str:
    try:
        # Be more careful with eval in production - consider using ast.literal_eval for safety
